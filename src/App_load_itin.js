  ...
  const handleFileUpload = (event) => {
    ...
    reader.onload = (e) => {
      try {
        ...
        if (json[0]?.arrival_date) setStartDate(json[0].arrival_date);
        // Set end date based on the loaded itinerary and start date
        const newStart = json[0]?.arrival_date || startDate;
